...
public static void main(String[] args) {
	int  pCalmas = 0, mNerv = 0, hAgre = 0, oCalmos = 0, pNervMais40 = 0, calmaMenos18 = 0, pessoas, i = 1, idade, nervos, sexo;	
	...
	while(i != pessoas+1) {
		...
		System.out.println("Idade "+ i + "ª pessoa: ");	
		idade = ler.nextInt();
		
		System.out.println("Sexo: [1]Feminino [2]Masculino [3]Outro : ");	
		sexo = ler.nextInt();
